...
export const follow = (userId: number): ThunkType => {
    return async (dispatch) => {
        await _followUnfollowFlow(dispatch, userId, followAPI.followUser.bind(usersAPI), actions.followSuccess)
    }
}
export const unFollow = (userId: number): ThunkType => {
    return async (dispatch) => {
        await _followUnfollowFlow(dispatch, userId, followAPI.unFollowUser.bind(usersAPI), actions.unFollowSuccess)
    }
}
